...
public final class Connect {
	...
	private final String DATABASE = "maskz"; // change with the database name that you use
	private final String HOST = "localhost:3306"; // change with your MySQL host, the default port is 3306
	private final String CONECTION = String.format("jdbc:mysql://localhost:3306/maskz", HOST, DATABASE);
